...
static final int[] jjnextStates = {
   21, 22, 23, 24, 25, 27, 3, 5, 22, 3, 29, 31, 33, 34, 9, 14, 
   10, 11, 13, 17, 19, 23, 24, 25, 27, 3, 5, 6, 7, 33, 34, 
};
public static final String[] jjstrLiteralImages = {
"", null, null, null, "\156\157\144\145", "\166\141\154\165\145\163", "\75", 
"\164\141\142\154\145", "\143\157\155\155\145\156\164", "\50", "\51", "\54", null, null, null, null, 
null, null, null, null, "\73", "\133", "\135", };
...
public ResultParseTokenManager(ASCII_CharStream stream)
{
   if (ASCII_CharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public ResultParseTokenManager(ASCII_CharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
