...
SystematicSamplingTable(Bnet b, Evidence e, int ls, int ss) {
...
public void simulate(int positionToSimulate, int iterations,
  ...
  /*
  // DEBUG
  System.out.println("position "+positionToSimulate);
  ...
  */
  if (positionToSimulate == -1) {  // We have an entire config.
    ...
    //System.out.println("PESO "+currentWeight+" ITERATIONS "+iterations);
