...
DefaultFinite.copy();
 ...
 Relation R;
    jj_consume_token(RELATION);
              R = new Relation();R.setVariables(Nodes);
    if (jj_2_50(4)) {
      jj_consume_token(47);
    } else if (jj_2_51(4)) {
      jj_consume_token(46);
 ...
 Token T;
  ...
  final public void ListAssignments(CaseList cases) throws ParseException {
    if (jj_2_63(4)) {
      label_5:
      while (true) {
        Assignment(cases);
  ...
  final public void Assignment(CaseList cases) throws ParseException {
 Vector V;
 Configuration C;
 Double D;
 Token T;
  ...
  final public Vector ListWordIntegers(CaseList cases) throws ParseException {
 Vector V;
 Token T;
 Integer I;
 int i;
 ...
 Token T;
  ...
  final private boolean jj_3_10() {
    ...
    jj_semLA = defaultnodetype==1;
    lookingAhead = false;
    if (!jj_semLA || jj_3R_14()) return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos) return false;
    xsp = jj_scanpos;
    if (jj_3_7()) {
    jj_scanpos = xsp;
