...
/**
  ...
  */
	...
	if ((int) conf.getValue(1)==1){
	   ...
	   prDocTer = aux ;//+ (1.0 -aux)*(1.0/Math.log(arg[1]));
        } else prDocTer = 1.0/Math.log(arg[0]);
...
/** This fuction restrict the potential, given that we know the values of a variable
  ...
  */
    ...
    for (i=0;i<pot.values.length; i++){
       pot.values[i] = inputPot.getFunction().PotValue(argAux, auxConf);
