...
public class DSeparation {
  ...
  /**
   * Contains the Bnet used for do the d-separation
   */
  Bnet bn;

  /**
   * Contains the evidence of the Bnet
   */
  Evidence evidence;
  boolean above[], below[];
  ...
  DSeparation(Bnet bnet,Evidence evid) {
    bn = bnet;
    evidence = evid;
  }
   ...
   * Returns a list of all variables whose distributions can
   * affect the marginal posterior of a given variable.
   * @param x is the index of the variable
   */
