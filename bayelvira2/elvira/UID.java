...
import elvira.inference.uids.DinamicUID;
...
import elvira.potential.*; 
	...
	public class UID extends IDWithSVNodes { 
		...
		public enum AlgorithmsForUID { AOUID, DINAMICUID, AODINAMICIMPROVEDUID, AODINAMICIMPROVEDRANDOMIZEDUID, AOUIDLOFH, AODINAMICIMPROVEDFIRSTBRANCHUID}
...
/*	public Propagation getPropagation() {
	...
	public void compile(int codeForCompile, Vector paramsForCompile) {
		...
		case AOUID:
		    ...
		    break;
		case DINAMICUID:
		    prop = new DinamicUID(this);
		    ((DinamicUID) prop).propagate();
		    break;
