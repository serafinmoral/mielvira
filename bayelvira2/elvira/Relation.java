...
//public static final int PRODUCT = 11;
  ...
  public Relation(Potential pot) {
   ...
   public Relation(PotentialTable pot) {
  ...
  /**
   * This method is used to get the node (first node) of the relation
   * @return the first node in the relation (the non-conditioning node)
   */
  ...
  public Node getNode() {
    ...
    return getVariables().elementAt(0);
