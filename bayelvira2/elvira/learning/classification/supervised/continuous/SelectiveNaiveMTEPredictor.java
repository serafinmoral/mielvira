...
public class SelectiveNaiveMTEPredictor extends NaiveMTEPredictor {
    ...
    public SelectiveNaiveMTEPredictor(DataBaseCases dbTrain, DataBaseCases dbTest, 
        ...
        //Compute the mutual informations Î(Xi,Y) and order them by decreasing way
        //---------------------------------------------------------------------      
...
private Vector OrderedIndexByMutualInformation (Vector W){
     ...
     *
     * Arguments:
     * 1. the train dbc file and the test dbc
     * 2. the number of intervals into which the domain of the continuous variables
     *    will be split.
    ...
    public static void main(String args[]) throws ParseException,IOException {
        ...
        try {
         ...
         pred.saveNetwork("SelectiveNB.elv");
       }catch(Exception e){}       
