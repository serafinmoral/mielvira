...
public class TANMTEPredictor {
    ...
    public TANMTEPredictor(DataBaseCases db, int cv, int intervals) {
        ...
        for (i=0;i<ll.size();i++){
         ...
         //value=2.0;
          ...
          //Estimate I(Xi,Xj|C)
          value=estimateConditionalMutualInformation(P_C, P_Xj_C, P_Xi_Xj_C, P_Xi_C,5000);
          vMutualInformation.addElement(value);             
          System.out.print("\nLINK: " + ((Link)ll.getLinks().elementAt(i)).toString()); 
          System.out.println("---------------------------------------------");
          System.out.println("     Î(Xi,Xj|C)="+ value);
          System.out.println("---------------------------------------------");
       ...
       CreateDirectedLinksFeatures(MaxTree.getMST().getLinkList(), variables.elementAt(root_index));
    ...
    * @param p4 = P(Xi|C)
    *
    * @return the conditional mutual information between both variables Î(Xi,Xj|C)
    *
    */     
    public double estimateConditionalMutualInformation(
...
/**
    ...
    public static void main(String args[]) throws ParseException,IOException {
        ...
        TANMTEPredictor pred = new TANMTEPredictor(cTrain,classv,interv);   
        ...
        System.out.println("MEAN --->  rmse_M: " + rmse_mean + "   lcc_M: "+ lcc_mean);       
        System.out.println("MEDIAN ->  rmse_M: " + rmse_median + "   lcc_M: "+ lcc_median);
        System.out.println("====================================================================\n\n");
