...
public class ConfusionMatrix  implements Serializable{
  ...
  protected double[] correctVector;
  ...
  public void actualize(int realClass, int assignedClass) {
    ...
    public void actualize(int realClass) {
    this.correctVector[realClass]++;
