...
public Vector classify(Configuration instance, int classnumber) { 
	...
	vresult.add(new Double(result[i]));
    return vresult;
}//end classify method
/*---------------------------------------------------------------*/ 
/**
 ...
 *  method is REçeduced Error Pruning.
 *  @return the error after prune
 */
...
public void learn (DataBaseCases training, int classnumber) {
    ...
    case ID3:    
	this.id3C45Dirichlet( training,  threshold , deeplimit, ID3,0,0);
	break;

    case C45: 
	this.id3C45Dirichlet( training,  threshold , deeplimit,C45,0,0);
	break;

    case DIRICHLET: 
	this.id3C45Dirichlet( training,  threshold , deeplimit,DIRICHLET,dirichletfactor,dirichletdeep);
	break;
 ...
 *               be classified
*/
public void id3(DataBaseCases cases) { 
    double  threshold=0.0;
    int deeplimit=128;    
    id3C45Dirichlet( cases,  threshold , deeplimit, ID3,0,0);
...
*/
public void id3(DataBaseCases cases, int deeplimit) { 
    double  threshold=0.0;
    id3C45Dirichlet( cases,  threshold , deeplimit,ID3,0,0);
...
*/
public void id3(DataBaseCases cases,  double  threshold) { 
    int deeplimit=128;    
    id3C45Dirichlet( cases,  threshold , deeplimit,ID3,0,0);
...
*/
public void id3(DataBaseCases cases,  double  threshold , int deeplimit) { 
     id3C45Dirichlet( cases,  threshold , deeplimit,ID3,0,0);
 ...
 *               be classified
*/
public void c45(DataBaseCases cases) { 
    double  threshold=0.0;
    int deeplimit=128;    
    id3C45Dirichlet( cases,  threshold , deeplimit,C45,0,0);
 ...
 *  @param deeplimit maximun recursive deep 
*/
public void c45(DataBaseCases cases, int deeplimit) { 
    double  threshold=0.0;
    id3C45Dirichlet( cases,  threshold , deeplimit,C45,0,0);
 ...
 *               of the classification tree
*/
public void c45(DataBaseCases cases,  double  threshold) { 
    int deeplimit=128;    
    id3C45Dirichlet( cases,  threshold , deeplimit,C45,0,0);
 ...
 *  @param deeplimit maximun recursive deep 
*/
public void c45(DataBaseCases cases,  double  threshold , int deeplimit) { 
    id3C45Dirichlet( cases,  threshold , deeplimit,C45,0,0);
...
*/
public void dirichlet(DataBaseCases cases, float dirichletfactor, int dirichletdeep ) { 
    double  threshold=0.0;
    int deeplimit=128;    
    id3C45Dirichlet( cases,  threshold , deeplimit,0,dirichletfactor,dirichletdeep);
 ...
 *  @param dirichletdeep acceptance and exploring  depth for worse child entropies.
*/
public void dirichlet(DataBaseCases cases, int deeplimit, float dirichletfactor, int dirichletdeep) { 
    double  threshold=0.0;
    id3C45Dirichlet( cases,  threshold , deeplimit,0,dirichletfactor,dirichletdeep);
 ...
 *  @param dirichletdeep acceptance and exploring  depth for worse child entropies.
*/
public void dirichlet(DataBaseCases cases,  double  threshold, float dirichletfactor, int dirichletdeep) { 
    int deeplimit=128;    
    id3C45Dirichlet( cases,  threshold , deeplimit,0,dirichletfactor,dirichletdeep);
 ...
 *  @param dirichletdeep acceptance and exploring  depth for worse child entropies.
*/
public void dirichlet(DataBaseCases cases,  double  threshold , int deeplimit, float dirichletfactor, int dirichletdeep) { 
     id3C45Dirichlet( cases,  threshold , deeplimit,0,dirichletfactor,dirichletdeep);
 ...
 *  @param dirichletdeep acceptance and exploring  depth for worse child entropies.
*/
private void id3C45Dirichlet(DataBaseCases cases,  double  threshold , int deeplimit, int method, float dirichletfactor, int dirichletdeep) { 
    //Iterators
    int i,j;
      ...
      switch ( method ) {
              ...
              case DIRICHLET: 
		          ...
		          int classnumber=((FiniteStates)(cases.getVariables()).elementAt(0)).getNumStates();
                          ...
                          classificationtree.dirichlet(cases,dirichletfactor,1);
			  break;
