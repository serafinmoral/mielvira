   ...
   public BICMetrics(){
	...
	if(valor == null){
     ...
     int i,j;
	   ...
	   total=0.0;
        ...
        for (i=0;i<nc;i++){
           ...
           // else {System.out.println ("Frecuencia 0 i= " + i + "j = " + j);}
        ...
        penal = 0.5*nx*(nc-1.0)*Math.log(M);
        
        //  System.out.println("First " + total + " Penal " + penal);
     ...
     int i,j;
      ...
      penal = 0.5*nx*(nc-1.0)*Math.log(M);
     //   penal = 0.5*nx*(nc-1.0)*Math.log(M)*Math.log(M);
