...
public class ElviraFrame extends JFrame implements ClipboardOwner {
  ...
  private JMenuItem newItem, openItem, openDBCItem, importItem, exportItem,
    ...
    loadEvidenceItem, saveEvidenceItem,
    closeItem, exitItem;
  ...
  private JMenuItem propagationMethodItem, generateDBCItem,
    ...
    public ElviraFrame() {
      ...
      case Elvira.SPANISH:
        ...
        String zoomChoices[] = {"500%", "300%", "200%", "150%",
        "100%", "75%", "50%", "25%", "10%" };
    ...
    public String getVisualPrecision() {
    	// Jorge-PFC 07/01/2006 ¿Se está en proceso de repintado de un frame?
    ...
    void showInfluencesEdition(){
        if (influenceLinkButton.isSelected()){
            influenceItem.setSelected(false);
            influenceLinkButton.setSelected(false);
            currentNetworkFrame.getEditorPanel().setInfluences(false);
        }
        else {
            influenceItem.setSelected(true);
            influenceLinkButton.setSelected(true);
            currentNetworkFrame.getEditorPanel().setInfluences(true);
        }
        currentNetworkFrame.getEditorPanel().repaint();
    }
   ...
   /* The next functions are mainly used by the methods implement
    ...
    public void closeAction(PropertyChangeEvent e) throws PropertyVetoException {
        ...
        // de la ventana, se estará comprobando si ha cambiado la red que no es!
    ...
    private boolean askWhetherAddATerminalValueNode(IDWithSVNodes id){
    	boolean propagate;
    	String msg;
    ...
    public void insertLastReference(String fileName, boolean isNew) {
        ...
        if (!isNew) {
            elements = fileMenu.getItemCount()-15;
            menuItemName = "1. "+fileName;
            position = 12;
        }
        else {
            elements = fileMenu.getItemCount()-14;
    ...
    public void saveLastReferences() {
        ...
        try {
            ...
            // 15 is the number of elements in the file menu that are not
            // name of files to save
            
            numberFiles=fileMenu.getItemCount()-15;
    ...
    public void loadLastReferences(ElviraFrame frame) {
        ...
        try {
         ...
         /* 14 is the number of elements of the file menu that are
          * always shown */
    ...
    public class LastReferenceListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (frame.fileMenu.getItemCount()==14) {
    ...
    * Añadido por Jorge-PFC el 05/12/2005
     ...
     * mediator creado pueda acceder a este atributo
     * 
     * Añadido por Jorge-PFC el 06/12/2005
     * 
     ...
     * mediator creado pueda acceder a esta toolbar y añada el
     ...
     * mediator creado pueda acceder a este atributo
     * 
     * Añadido por Jorge-PFC el 08/12/2005
     *      
     ...
     * mediator creado pueda acceder a este atributo
     * 
     * Añadido por Jorge-PFC el 27/12/2005
     * 
