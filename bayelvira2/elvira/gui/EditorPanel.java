...
//    if (link.getColorLink()==null){
    	...
    	if (((bayesNet.getClass()==Bnet.class)||(bayesNet.getClass()==IDiagram.class)||(bayesNet.getClass()==IDWithSVNodes.class))
    			&&showInfluences){
          	System.out.println("Pasa por showInfluences");
...
//          macroExplanation.print(dist);
  ...
  if (mode==SELECTING) {
   ...
   public void createNode(int x, int y) {
      ...
      switch (nodeType) {
         case 0: nodeName = bayesNet.generateName(chanceNodes);
                 chanceNodes++;
                 break;
         case 1: nodeName = bayesNet.generateSpecialName("D",decisionNodes);
                 decisionNodes++;
                 break;
         case 2: nodeName = bayesNet.generateSpecialName("U",utilityNodes);
                 utilityNodes++;
                 break;
      }
