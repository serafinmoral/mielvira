...
public class NetworkPropertiesDialog extends javax.swing.JDialog
{
    ...
    */
	...
	public NetworkPropertiesDialog(Frame parent)
	{
		...
		iDiagramRadioButton.setBounds(24,64,160,29);
	 ...
	 */
        ...
        public void getInformationFromDialog () {
            ...
            if ((iDiagramRadioButton.isSelected()) && (bayesNet.getClass() != IDWithSVNodes.class)) {
              /*if (!newNetwork)
                if (!(bayesNet.getClass()==IDiagram.class)) {
                 Object[] options = { localize(dialogBundle,"Yes.label"), localize(dialogBundle,"No.label") };

                 int reply = JOptionPane.showOptionDialog (null, localize(dialogBundle,"Quit.Text.label"),
                     localize(dialogBundle,"Quit.Title.label"),
                     JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE,
                     null, options, options[1]);
                 if (reply==0) {
                   IDiagram tmp = new IDiagram();
                   tmp = (IDiagram) bayesNet;
                   bayesNet = tmp;
                 }
                }
                else*/
                  //bayesNet = new IDiagram();
              if (!newNetwork) {
                if (!(bayesNet.getClass() == IDWithSVNodes.class)) {
            ...
            else if ((bNetRadioButton.isSelected()) && (bayesNet.getClass() != Bnet.class)) {
              if (!newNetwork) {
