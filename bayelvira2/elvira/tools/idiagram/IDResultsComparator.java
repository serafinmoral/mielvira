...
import elvira.inference.elimination.VEWPTAndConstraints;
...
//System.out.println("Políticas óptimas de referencia: ");
//reference.print();
//System.out.println();
//System.out.println("Políticas óptimas de la propagación : ");
//propagation.print();
//System.out.println("----------------------------------------------");
...
//System.out.println("Comparando políticas globales....... ("+index+")");
...
//progUtilPot.print();
//System.out.println("-------------------------------------------");
//System.out.println("Política de referencia.....................");
//reference.print();
//System.out.println("-------------------------------------------");
//System.out.println("Políticas de propagación...................");
//propagation.print();
//System.out.println("-------------------------------------------");
...
System.out.println("Analizando caso: "+i);
 ...
 public static void main(String args[]) throws ParseException, IOException{
    if (args.length < 1){
      ...
      VEWPTAndConstraints propagation=new VEWPTAndConstraints((Bnet)red);
