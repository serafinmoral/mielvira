...
public class QualitativeVariableElimination extends elvira.inference.elimination.VariableElimination { 
...
public QualitativeVariableElimination(IDiagram id) {
...
public QualitativeVariableElimination(IDiagram id,boolean toClean) {
    super(id.qualitativeCopyWithRelations());
    orderOfElimination=new Vector();
    decisionTables=new RelationList();
    if (toClean == true){
...
public static void main(String args[]) throws ParseException, IOException { 
  ...
  eval=new QualitativeVariableElimination(diag);
