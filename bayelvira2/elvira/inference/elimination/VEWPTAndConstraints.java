...
public class VEWPTAndConstraints extends VariableElimination {
...
/**
 * A member to store the level of approximation on trees
 */
...
public static void main(String args[]) throws ParseException, IOException {
  ...
  if (args.length < 3){
    ...
    ve = new VEWPTAndConstraints((Bnet)b,e);
    ve.obtainInterest();
...
public VEWPTAndConstraints(Bnet b, Evidence e) {
...
public VEWPTAndConstraints(Bnet b) {
...
public Potential transformAfterAdding(Potential potential) {
  ...
  pot = (PotentialTree) pot.sortAndBound(thresholdForPrunning);
