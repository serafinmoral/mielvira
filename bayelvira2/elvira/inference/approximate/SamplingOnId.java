...
public class SamplingOnId extends Propagation{
  ...
  private QualitativeVariableElimination qualitativeEval;
  ...
  private VEWPTAndConstraints quantitativeEval;
  ...
  public SamplingOnId(IDiagram diag, String phases, String samples){
     ...
     quantitativeEval=new VEWPTAndConstraints(diag);
     ...
     qualitativeEval=new QualitativeVariableElimination(diag);
