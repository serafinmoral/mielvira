...
public class VectorOps {
	 ...
	 */
	public static double[] randomDiscreteDistribution(int states) {
		double[] result=new double[states];
		double r=1.0;
		double power=1.0/(states-1);
		for (int i=0; i<states-1; i++) {
			result[i]=r*(1.0-Math.pow(1.0-Math.random(),power));
			r-=result[i];
		}
		result[states-1]=r;
		return result;
...
//	}
	...
	public static final void printMeanVarSD(double[] c){
